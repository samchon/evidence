import { EvidenceAccessor, EvidenceDbmlAdapter } from "evidence";
import type { EvidenceDatabaseSymbol } from "evidence";
import { dedent } from "@typia/utils";

import type { IEvidenceDatabaseAdapterCertification } from "./certification/IEvidenceDatabaseAdapterCertification";
import type { IEvidenceDatabaseAdapterCertificationUnit } from "./certification/IEvidenceDatabaseAdapterCertificationUnit";

/**
 * Independent exact fixture for DBML schema declarations and annotation
 * ownership.
 */
export namespace EvidenceDbmlCertificationFixture {
  /**
