...
export namespace EvidAdapterCertificationFixtures {
  export function all(): IEvidAdapterCertification[] {
    return [
      ...
      kotlin(),
      objc(),
      EvidLuaCertificationFixture.create(),
      dart(),
      zig(),
      scala(),
      matlab(),
  ...
  function objc(): IEvidAdapterCertification {
  ...
  function typescript(): IEvidAdapterCertification {
  ...
  function javascript(): IEvidAdapterCertification {
  ...
  function python(): IEvidAdapterCertification {
  ...
  function go(): IEvidAdapterCertification {
  ...
  function rust(): IEvidAdapterCertification {
  ...
  function php(): IEvidAdapterCertification {
  ...
  function java(): IEvidAdapterCertification {
  ...
  function swift(): IEvidAdapterCertification {
  ...
  function zig(): IEvidAdapterCertification {
  ...
  function csharp(): IEvidAdapterCertification {
  ...
  function c(): IEvidAdapterCertification {
  ...
  function cpp(): IEvidAdapterCertification {
  ...
  function ruby(): IEvidAdapterCertification {
  ...
  function unit(
    ...
    sites: number = 1,
  ): IEvidAdapterCertificationUnit {
    const addresses: IEvidAdapterCertificationAddress[] = [
      identity,
      ...aliases,
    ].map((segments) => ({
      file,
  ...
  function hosts(
    ...
    callable: string,
    property: string,
  ): IEvidAdapterCertification["hosts"] {
  ...
  function requirements(
    ...
    callable: string,
    property: string,
  ): IEvidAdapterCertificationRequirement[] {
    return [
  ...
  function mutation(
    ...
    contentAfter: string,
  ): IEvidAdapterCertification["mutation"] {
    return {
      unit: unitKey,
