...
import { EvidTestGraph } from "../EvidTestGraph";
import { EvidTestSourceSnapshot } from "../EvidTestSourceSnapshot";
import type { IEvidAdapterCertification } from "./IEvidAdapterCertification";
import type { IEvidDatabaseAdapterCertification } from "./IEvidDatabaseAdapterCertification";
...
export namespace EvidAdapterCertification {
  ...
  function snapshot(
    ...
    return EvidTestSourceSnapshot.combine(
      sources.map(
        (source: IEvidAdapterCertificationSource): IEvidSourceSnapshot => {
          const snapshot: IEvidSourceSnapshot = EvidTestSourceSnapshot.create(
            source.file,
            source.content,
            [source.file],
            root,
  ...
  ): IEvidAdapterCertificationUnitBase<
  ...
  function normalizeExpectedUnit(
    unit: IEvidAdapterCertificationUnitBase<
      EvidProgrammingSymbol | EvidDatabaseSymbol
    >,
  ): IEvidAdapterCertificationUnitBase<
    EvidProgrammingSymbol | EvidDatabaseSymbol
  ...
  function normalizeHost(
    host: IEvidAdapterCertificationHost,
  ): IEvidAdapterCertificationHost {
  ...
  function compareKey(
    left: IEvidAdapterCertificationUnitBase<
      EvidProgrammingSymbol | EvidDatabaseSymbol
    >,
    right: IEvidAdapterCertificationUnitBase<
      EvidProgrammingSymbol | EvidDatabaseSymbol
    >,
  ): number {
  ...
  function compareAddress(
    left: IEvidAdapterCertificationAddress,
    right: IEvidAdapterCertificationAddress,
  ): number {
    return compare(
