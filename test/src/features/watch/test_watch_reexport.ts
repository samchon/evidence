 ...
 *
 * Watch cycles must reflect public target aliases and parser failures
 * immediately, with each non-failed result matching a fresh one-shot checker
 * report.
 *
 ...
 * 4. Restore the barrel export and implementation, then require cycle 4 to succeed
