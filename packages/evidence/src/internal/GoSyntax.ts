...
export namespace GoSyntax {
  ...
  export function names(node: Node, type: string): string[] {
  ...
  export function receiver(node: Node): string | undefined {
  ...
  export function embeddedField(node: Node | null): string | undefined {
  ...
  export function literal(node: Node): IEvidenceCommentSyntax | undefined {
  ...
  function receiverName(node: Node | null): string | undefined {
    if (node === null) return undefined;
    const direct = name(node);
    if (direct !== undefined) return direct;
    if (node.type === "generic_type")
