...
export class JavaAdapter implements IEvidenceAdapter {
  ...
  private materializeUndocumentedHosts(
    ...
    const groups = new Map<string, IJavaDeclaration[]>();
    for (const declaration of analysis.declarations) {
  ...
  private parse(
    ...
    return EvidenceTagParser.parse(
      source.content,
      host,
      JavaDocumentation.read(source, documentation, host.id),
    );
  }
  ...
  private annotation(
    ...
    return this.annotationPattern(
      JavaDocumentation.read(analysis.source, documentation, documentation.id)
        .text,
      true,
    );
  }
  ...
  private unitId(declaration: IJavaDeclaration): string {
