...
export namespace CppSyntax {
  ...
  export function declarator(node: Node): ICppDeclaratorShape | undefined {
    let current: Node | null = node;
    let nearest: CppDeclaratorKind = "direct";
    while (current !== null) {
  ...
  export function recordForm(
    node: Node | null,
  ): Extract<CppDeclarationForm, "class" | "struct" | "union" | "enum"> | null {
  ...
  export function templateArity(node: Node): number {
  ...
  export function templateBody(node: Node): Node | undefined {
  ...
  export function topLevelConstObject(node: Node, declarator: Node): boolean {
  ...
  export function access(node: Node): CppAccess | undefined {
  ...
  function templateParameter(node: Node): boolean {
