 ...
 * rejects malformed condition objects. ConfigDependencyScanner uses this error
 * boundary to preserve that distinction without matching diagnostic text.
 */
export class ConfigPackageTargetError extends Error {
  /**
  ...
  public constructor(message: string, cause?: unknown) {
    ...
    this.name = "ConfigPackageTargetError";
  }
}
