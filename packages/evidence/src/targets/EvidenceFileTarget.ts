 ...
 *
 * @example
 * EvidenceFileTarget.parse("../api/client.ts#Client.prototype.send", "/repo/docs/guide.md");
 */
export namespace EvidenceFileTarget {
   ...
   * whereas accessor parsing remains delegated to `EvidenceAccessor`. The origin
