 ...
 * extension.
 */
export interface IEvidenceKotlinDeclaration {
  /**
  ...
  /**
   * Classifies the declaration in evidence's language-independent selector
   * vocabulary.
   *
   ...
   */
  aliasTarget?: IEvidenceKotlinTypeReference;
   ...
   */
  receiver?: IEvidenceKotlinTypeReference;
