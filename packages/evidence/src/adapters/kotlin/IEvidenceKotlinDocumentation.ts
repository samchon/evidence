...
import type { IEvidenceKotlinDocumentationAttachment } from "./IEvidenceKotlinDocumentationAttachment";
 ...
 */
export interface IEvidenceKotlinDocumentation {
  /**
   ...
   * and unit resolution.
   */
  attachments: IEvidenceKotlinDocumentationAttachment[];
}
