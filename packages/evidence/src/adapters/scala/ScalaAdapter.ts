...
export class ScalaAdapter implements IEvidenceAdapter {
  ...
  private materializeUndocumentedHosts(
    ...
    const groups = new Map<string, IScalaDeclaration[]>();
    for (const declaration of analysis.declarations) {
  ...
  private parse(
    ...
    return EvidenceTagParser.parse(
      source.content,
      host,
      ScalaDocumentation.read(source, documentation, host.id),
    );
  }
  ...
  private annotation(
    ...
    return this.annotationPattern(
      ScalaDocumentation.read(analysis.source, documentation, documentation.id)
        .text,
      true,
    );
  }
