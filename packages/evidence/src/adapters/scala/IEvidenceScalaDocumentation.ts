...
import type { IEvidenceScalaDocumentationAttachment } from "./IEvidenceScalaDocumentationAttachment";
 ...
 */
export interface IEvidenceScalaDocumentation {
  /**
   ...
   */
  attachments: IEvidenceScalaDocumentationAttachment[];
}
