 ...
 *
 * CppFileScanner emits this physical record alongside declarations, and
 * CppAdapter resolves public aliases after it materializes semantic units.
...
export interface ICppAlias {
  /** Stable scanner-local key used to associate the alias with its source analysis.
   *
   ...
   *
   * Private aliases remain available for local resolution but expose no address. */
  public: boolean;
}
