 ...
 */
export namespace EvidencePostgresqlOwnership {
  /**
   ...
   */
  export function resolve(input: IEvidenceSqlFileAnalysis[]): void {
    const analyses = typia.assert<IEvidencePostgresqlFileAnalysis[]>(input);
