...
import type { IEvidenceRustDocumentationAttachment } from "./IEvidenceRustDocumentationAttachment";
 ...
 * diagnosable hosts.
 */
export interface IEvidenceRustDocumentation {
  /**
   ...
   * host.
   */
  attachments: IEvidenceRustDocumentationAttachment[];
