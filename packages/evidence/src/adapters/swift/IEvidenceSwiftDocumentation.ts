...
import type { IEvidenceSwiftDocumentationAttachment } from "./IEvidenceSwiftDocumentationAttachment";
 ...
 */
export interface IEvidenceSwiftDocumentation {
  /**
   ...
   */
  attachments: IEvidenceSwiftDocumentationAttachment[];
}
