...
import type { IEvidenceObjcDocumentationAttachment } from "./IEvidenceObjcDocumentationAttachment";
 ...
 */
export interface IEvidenceObjcDocumentation {
  /**
   ...
   */
  attachments: IEvidenceObjcDocumentationAttachment[];
}
