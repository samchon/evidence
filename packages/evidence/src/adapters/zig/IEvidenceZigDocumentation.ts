...
import type { IEvidenceZigDocumentationAttachment } from "./IEvidenceZigDocumentationAttachment";
 ...
 * host.
 */
export interface IEvidenceZigDocumentation {
  /**
   ...
   */
  attachments: IEvidenceZigDocumentationAttachment[];
}
