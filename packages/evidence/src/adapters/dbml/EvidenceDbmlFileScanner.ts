 ...
 */
export class EvidenceDbmlFileScanner {
  /**
   ...
   */
  private readonly output: IEvidenceDbmlFileAnalysis;
   ...
   */
  public scan(): IEvidenceDbmlFileAnalysis {
   ...
   * fingerprints.
   */
  private enumeration(node: EvidenceNode): void {
   ...
   */
  private relation(node: EvidenceNode): void {
   ...
   * files.
   */
  private endpoint(node: EvidenceNode): IEvidenceDbmlEndpoint {
   ...
   * path separators.
   */
  private tableName(node: EvidenceNode): string[] {
   ...
   * resolution.
   */
  private identifier(node: EvidenceNode): string {
   ...
   * declaration.
   */
  private comment(node: EvidenceNode): void {
   ...
   */
  private standalone(node: EvidenceNode): boolean {
    const start =
   ...
   */
  private adjacent(previous: EvidenceNode, next: EvidenceNode): boolean {
   ...
   * annotation carriers.
   */
  private note(node: EvidenceNode): void {
   ...
   * fingerprint.
   */
  private semantic(node: EvidenceNode): string {
