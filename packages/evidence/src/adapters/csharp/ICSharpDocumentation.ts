 ...
 *
 * CSharpFileScanner records its physical range, comment syntax, and accepted
 * declaration sites without binding it to a semantic unit. CSharpAdapter later
...
export interface ICSharpDocumentation {
   ...
   *
   * CSharpDocumentation passes it to the shared documentation reader so line
