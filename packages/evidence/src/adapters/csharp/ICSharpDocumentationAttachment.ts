 ...
 *
 * ICSharpDocumentation stores these physical links while parsing is still close
 * to source syntax. CSharpAdapter resolves the declaration record to a published
...
export interface ICSharpDocumentationAttachment {
   ...
   *
   * CSharpAdapter looks up this key in its published-declaration map to find the
