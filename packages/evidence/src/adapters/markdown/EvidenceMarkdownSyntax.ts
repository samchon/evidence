 ...
 */
export namespace EvidenceMarkdownSyntax {
   ...
   */
  export function fence(line: string): IEvidenceMarkdownFence | undefined {
    let indent = 0;
   ...
   * prose.
   */
  export function heading(line: string): IEvidenceMarkdownHeading | undefined {
    let cursor = 0;
