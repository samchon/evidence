...
import type { IEvidenceSqlDocumentationAttachment } from "./IEvidenceSqlDocumentationAttachment";
 ...
 */
export interface IEvidenceSqlDocumentation {
  /**
   ...
   * diagnostics.
   */
  attachments: IEvidenceSqlDocumentationAttachment[];
}
