 ...
 * file.
 */
export class EvidenceMatlabFileScanner {
  /**
   ...
   */
  private readonly declarations: IEvidenceMatlabDeclaration[] = [];
   ...
   */
  private readonly documentation: IEvidenceMatlabDocumentation[] = [];
   ...
   * population.
   */
  public scan(): IEvidenceMatlabFileAnalysis {
   ...
   * policy.
   */
  private attributes(node: EvidenceNode): Map<string, string> {
  ...
  private add(
    ...
    owner: IEvidenceMatlabDeclaration | undefined,
    visible: boolean,
  ): IEvidenceMatlabDeclaration | undefined {
    ...
    const declaration: IEvidenceMatlabDeclaration = {
      id,
      name,
      symbol,
      identity: address,
   ...
   */
  private lineStart(node: EvidenceNode): boolean {
    const start =
