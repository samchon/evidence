 ...
 * closes. PythonAdapter later filters it by public reachability before creating
 * evidence hosts, so a private declaration's docstring cannot document an
 * exported unit by accident.
 */
export interface IPythonDocumentationAttachment {
  /**
