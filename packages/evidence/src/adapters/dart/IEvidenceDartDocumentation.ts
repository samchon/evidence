...
import type { IEvidenceDartDocumentationAttachment } from "./IEvidenceDartDocumentationAttachment";
 ...
 * it.
 */
export interface IEvidenceDartDocumentation {
  /**
   ...
   * reconciliation.
   */
  attachments: IEvidenceDartDocumentationAttachment[];
}
