 ...
 */
export namespace EvidenceSwaggerRemoteReader {
  /**
   ...
   */
  export async function read(url: URL): Promise<IEvidenceRemoteSwaggerSource> {
 ...
 */
function decode(bytes: Uint8Array): IEvidenceRemoteSwaggerSource {
  return {
