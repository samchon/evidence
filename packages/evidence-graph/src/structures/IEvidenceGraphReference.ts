 ...
 * sections, or selected exported TypeScript symbols. Every unit it materializes
 * must be acknowledged by the owning claim, so a reference is the denominator
 * of one coverage obligation, never a pooled global set.
 */
