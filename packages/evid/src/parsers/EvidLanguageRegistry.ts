...
import type { IEvidDatabaseLanguage } from "../structures/IEvidDatabaseLanguage";
import { EvidParserError } from "./EvidParserError";
import type { IEvidLanguage } from "../structures/IEvidLanguage";
import type { IEvidLanguageCandidate } from "../structures/IEvidLanguageCandidate";
import type { IEvidLanguageGrammar } from "../structures/IEvidLanguageGrammar";
 ...
 */
export namespace EvidLanguageRegistry {
  /**
  ...
  export function select(
    ...
    if (language === undefined)
      throw new EvidParserError(
        ...
        file,
        `No registered grammar for ${type}. Add its grammar and Evid adapter before selecting it.`,
      );
  ...
  const DATABASES: IEvidDatabaseLanguage[] = [
    {
      type: "sqlite",
      name: "SQLite",
      grammars: [
  ...
  const LANGUAGES: IEvidLanguage[] = [
    {
      type: "objc",
      name: "Objective-C",
      grammars: [{ id: "objc", extensions: [".m", ".h"], filenames: [] }],
      adapter: {
        entry: "EvidObjcAdapter",
  ...
  const CANDIDATES: IEvidLanguageCandidate[] = [
    {
      id: "vue",
