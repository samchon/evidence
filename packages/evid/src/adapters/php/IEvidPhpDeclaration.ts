 ...
 *
 * EvidPhpAdapterBase groups these lexical records into semantic units, retaining exact
...
export interface IEvidPhpDeclaration {
   ...
   *
   * EvidPhpAdapterBase applies PHP case rules to this path without changing public spelling.
   */
  identity: string[];
