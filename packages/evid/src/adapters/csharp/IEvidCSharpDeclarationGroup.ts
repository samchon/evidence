 ...
 *
 * `EvidCSharpAdapterBase` builds these groups while materializing a source snapshot and
 * checks the contained declarations for compatible partial or overload forms.
 * The group bridges scanner-local declaration records and the single published
 * Evid unit, retaining every contributing site and address candidate.
 */
