 ...
 * declaration site.
 *
 * IEvidCSharpDocumentation stores these physical links while parsing is still
 * close to source syntax. EvidCSharpAdapterBase resolves the declaration record
 * to a published semantic unit and groups links by site when it creates
 * evidence hosts.
 */
export interface IEvidCSharpDocumentationAttachment {
   ...
   * documentation.
   *
   * EvidCSharpAdapterBase looks up this key in its published-declaration map to
