import { EvidCSharpAdapterBase } from "./EvidCSharpAdapterBase";
 ...
 * namespace and owner segments, with literal spelling for generic arity,
 * indexers, and operators rather than flattening those forms into ordinary
 * identifiers.
 *
 ...
 * source boundary. Complete syntax alone does not establish their public
 * inventory.
 */
export class EvidCSharpAdapter extends EvidCSharpAdapterBase {}
