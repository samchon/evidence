 ...
 */
export namespace EvidSwaggerRemoteReader {
  /**
   ...
   */
  export async function read(url: URL): Promise<IEvidRemoteSwaggerSource> {
 ...
 */
function decode(bytes: Uint8Array): IEvidRemoteSwaggerSource {
  return {
