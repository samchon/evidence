...
import type { IEvidPythonModule } from "./IEvidPythonModule";
import type { IEvidPythonResolution } from "./IEvidPythonResolution";
import type { IEvidPythonResolvedBinding } from "./IEvidPythonResolvedBinding";
import type { EvidPythonResolutionMode } from "./EvidPythonResolutionMode";
 ...
 */
export class EvidPythonExportResolver {
  /**
   ...
   */
  private readonly modules = new Map<string, IEvidPythonModule>();
   ...
   * of the cache key.
   */
  private readonly resolutions = new Map<string, IEvidPythonResolution>();
   ...
   */
  public constructor(
    analyses: IEvidPythonFileAnalysis[],
  ...
  private resolve(
    sourceId: string,
    name: string,
    mode: EvidPythonResolutionMode,
  ): IEvidPythonResolution {
  ...
  private resolveBinding(
    module: IEvidPythonModule,
    binding: IEvidPythonBinding,
    name: string,
    visited: Set<string>,
  ): IEvidPythonResolution {
  ...
  private publishBinding(
    ...
    binding: IEvidPythonResolvedBinding,
    prefix: string[],
    visited: Set<string>,
   ...
   */
  private problem(
    source: IEvidSourceFile | undefined,
    message: string,
    repair: string,
    key: string,
  ): void {
