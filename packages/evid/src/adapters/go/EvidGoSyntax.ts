...
export namespace EvidGoSyntax {
  ...
  export function names(node: EvidNode, type: string): string[] {
  ...
  export function receiver(node: EvidNode): string | undefined {
  ...
  export function embeddedField(node: EvidNode | null): string | undefined {
  ...
  export function literal(node: EvidNode): IEvidCommentSyntax | undefined {
  ...
  function typeName(node: EvidNode | null): string | undefined {
  ...
  function receiverName(node: EvidNode | null): string | undefined {
    if (node === null) return undefined;
    const direct = name(node);
    if (direct !== undefined) return direct;
    if (node.type === "generic_type")
