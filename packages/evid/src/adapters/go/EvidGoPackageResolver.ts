...
import type { IEvidGoMaterializedDeclaration } from "./IEvidGoMaterializedDeclaration";
...
export class EvidGoPackageResolver {
  ...
  public publish(): Map<string, string> {
    ...
    const types = new Map<string, IEvidGoMaterializedDeclaration[]>();
  ...
  private materialize(
    ...
    owners: IEvidGoMaterializedDeclaration[],
  ): void {
  ...
  private validatePackages(): void {
    const directories = new Map<string, IEvidGoFileAnalysis[]>();
  ...
  ): IEvidGoMaterializedDeclaration {
    const identity =
      declaration.owner === undefined
        ? [declaration.name]
        : [declaration.owner, declaration.name];
   ...
   */
  private ownerKey(analysis: IEvidGoFileAnalysis, name: string): string {
   ...
   */
  private packageKey(analysis: IEvidGoFileAnalysis): string {
  ...
  private problem(
    code: string,
    analysis: IEvidGoFileAnalysis | undefined,
    message: string,
    repair: string,
    key: string,
  ): void {
