 ...
 *
 * An {@link IEvidDartDirective} owns these filters, and EvidDartLibraries applies them
 * in sequence while deciding whether each exported top-level name is public.
 */
export interface IEvidDartExportFilter {
  /**
