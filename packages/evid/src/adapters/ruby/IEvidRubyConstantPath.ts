 ...
 *
 * EvidRubyFileScanner uses it to distinguish lexical nesting from top-level constants
 * before reopened declarations and visibility transitions are reconciled.
 */
