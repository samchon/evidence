import { EvidRubyAdapterBase } from "./EvidRubyAdapterBase";

/**
 * Extracts explicit Ruby declarations, reopenings, and bounded aliases from
 * selected source.
 *
 ...
 * attachment. Instance members use their nominal owner directly, while
 * singleton members add a self segment, keeping equal method names on different
 * sides distinct.
 *
 ...
 */
export class EvidRubyAdapter extends EvidRubyAdapterBase {}
