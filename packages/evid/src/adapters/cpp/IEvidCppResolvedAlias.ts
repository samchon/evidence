 ...
 *
 * `EvidCppAdapterBase.resolveAliases` creates this intermediate result after declaration families are materialized. The adapter then publishes addresses for `target` and its nested units while retaining `analysis` to report address conflicts against the originating source file.
 */
