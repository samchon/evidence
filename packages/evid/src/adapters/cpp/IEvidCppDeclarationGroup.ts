 ...
 *
 * EvidCppAdapterBase builds these groups from scanner records using `id`, then uses
 ...
 */
export interface IEvidCppDeclarationGroup {
  /**
   * Semantic unit ID shared by every declaration in this group.
   *
   * EvidCppAdapterBase derives it from the declarations' symbol and qualified identity
