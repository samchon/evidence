...
/**
 * Extracts explicit Objective-C interfaces, protocols, categories, and public
 * members.
 *
 ...
 * minus prefix and every colon, keeping class and instance methods
 * distinguishable.
 *
 * Objective-C++, preprocessing, include traversal, external C aggregate/data
 * declarations, compatibility aliases, and inherited or synthesized
 * declarations are outside this selected-source boundary.
 */
