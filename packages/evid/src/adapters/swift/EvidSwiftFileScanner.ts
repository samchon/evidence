 ...
 */
export class EvidSwiftFileScanner {
  /**
   ...
   */
  private readonly documentation = new Map<number, IEvidSwiftDocumentation>();
   ...
   */
  public scan(): IEvidSwiftFileAnalysis {
  ...
  private walk(
    container: EvidNode,
    owner: IEvidSwiftDeclaration | undefined,
  ...
  private declare(
    ...
    const declaration: IEvidSwiftDeclaration = {
  ...
  private collectDocumentation(): void {
    ...
    let previous: IEvidSwiftDocumentation | undefined;
