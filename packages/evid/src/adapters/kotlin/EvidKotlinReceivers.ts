...
import type { IEvidKotlinResolvedType } from "./IEvidKotlinResolvedType";
...
export namespace EvidKotlinReceivers {
   ...
   */
  export function resolve(analyses: IEvidKotlinFileAnalysis[]): void {
    const types = new Map<string, IEvidKotlinDeclaration[]>();
  ...
  function lookup(
    ...
    types: Map<string, IEvidKotlinDeclaration[]>,
    visited: Set<string>,
  ): IEvidKotlinResolvedType | undefined {
