 ...
 *
 * KDoc tags can acknowledge Evid, whereas examples are prose and must not
 * create declarations despite containing text that resembles an annotation.
 */
export namespace EvidKotlinDocumentation {
  /**
   ...
   * retain EvidDocumentation's normalized text and source mapping unchanged.
   */
