 ...
 *
 * EvidConfigDependencyScanner validates this narrow projection from fresh manifest
...
export interface IEvidConfigResolutionManifest {
   ...
   * EvidNode's `index` fallback; subpath requests do not use this root field because
