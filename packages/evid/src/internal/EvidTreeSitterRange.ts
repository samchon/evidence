...
/**
 * Converts web-tree-sitter UTF-16, zero-based coordinates into Evid source
 * ranges.
 *
...
export namespace EvidTreeSitterRange {
   ...
   * are incremented to the one-based positions expected by Evid consumers.
   */
  export function from(node: Node): IEvidSourceRange {
    return {
      start: {
