import type { IEvidGraphObligation } from "./IEvidGraphObligation";
 ...
 * from configuration. `EvidCheckProgrammer` later joins it to the plan to
 * produce a report. A complete claim population does not imply complete or
 * covered reference obligations.
 */
export interface IEvidGraphClaimResult {
  /**
   ...
   */
  obligations: IEvidGraphObligation[];
}
