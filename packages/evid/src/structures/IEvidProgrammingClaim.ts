 ...
 *
 * The language adapter extracts declaration identity and documentation ownership
 * before the configured symbol selector chooses claim hosts. This lets one
 * policy require evidence from public functions while still recognizing an
 * exclusion authored on another eligible declaration in the selected files.
 *
